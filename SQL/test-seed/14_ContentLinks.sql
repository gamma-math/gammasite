...
((SELECT `Id` FROM `ContentItems` WHERE `Slug` = 'faglig-aften-oktober-2026' LIMIT 1), 'Facebook-event', 'https://fb.me/e/7LU6GEbOT/', 'FACEBOOK', 0, '2026-09-08 10:05:00', '2026-09-08 10:05:00');
